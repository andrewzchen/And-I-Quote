// This module was created by Nate Tyler in order to use the wikiquotes api
// I then adapted it to get a list of 10 quotes from a search
// Getting quotes from the wikiquotes api isn't very feasible without using a module like this one
// Link: https://github.com/natetyler/wikiquotes-api
  ...
  wqa.getRandomQuote = function(titles, success, error) {
    ...
    //  var randomNum = Math.floor(Math.random()*quotes.quotes.length);
      // success({ titles: quotes.titles, quote: quotes.quotes[randomNum] });
        success({ titles: quotes.titles, quote: quotes.quotes});
    };
